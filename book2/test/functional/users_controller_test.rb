...
class UsersControllerTest < ActionController::TestCase
  ...
  def test_should_log_in
  	...
  	post :login, :username => casoler.username, :password => casoler.password, :first_name => casoler.first_name
   ...
   def test_should_be_bad_login
  	casoler = users(:casoler)
  	post :login, :username => casoler.username, :password => 'nogood', :first_name => casoler.first_name
